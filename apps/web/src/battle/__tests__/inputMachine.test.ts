...
describe("idle", () => {
  ...
  it("endTurnPressed → 확인 다이얼로그(미행동 수) → endTurnConfirm 시 전원 wait 순차 커밋", () => {
    const one = withUnit(state0, GUANYU, { acted: true });
    // 1단계: 누름 → 확인 다이얼로그(미행동 3기), 커밋 없음
    const r1 = reduceInput({ kind: "idle" }, { type: "endTurnPressed" }, ctx, one);
    expect(r1.next).toEqual({ kind: "confirmEndTurn", remaining: 3 });
    expect(r1.effects).toEqual([]);
    // 2단계: 확인("예") → animating + 미행동 아군 전원 wait 순차 커밋
    const r2 = reduceInput(r1.next, { type: "endTurnConfirm" }, ctx, one);
    expect(r2.next).toEqual({ kind: "animating" });
  ...
  it("confirmEndTurn × cancel → 아군 페이즈 복귀(idle), 커밋 없음", () => {
    const one = withUnit(state0, GUANYU, { acted: true });
    const r = reduceInput({ kind: "confirmEndTurn", remaining: 3 }, { type: "cancel" }, ctx, one);
    expect(r.next).toEqual({ kind: "idle" });
    expect(r.effects).toEqual([]);
  });
...
describe("전이 전수 — 모든 (상태, 이벤트) 조합이 던지지 않고 허용 전이표를 따른다", () => {
  ...
  const states: InputState[] = [
    ...
    { kind: "enemyTurn" },
    { kind: "autoTurn" },
    { kind: "confirmEndTurn", remaining: 2 },
  ...
  const table: Record<InputState["kind"], Record<UiEvent["type"], InputState["kind"]>> = {
    idle: { tapTile: "idle", cancel: "idle", menuAttack: "idle", menuStrategy: "idle", selectStrategy: "idle", menuItem: "idle", selectItem: "idle", menuWait: "idle", menuCancel: "idle", endTurnPressed: "confirmEndTurn", endTurnConfirm: "idle", autoStart: "autoTurn", drained: "idle" },
    selected: { tapTile: "idle", cancel: "idle", menuAttack: "selected", menuStrategy: "selected", selectStrategy: "selected", menuItem: "selected", selectItem: "selected", menuWait: "selected", menuCancel: "selected", endTurnPressed: "selected", endTurnConfirm: "selected", autoStart: "selected", drained: "selected" },
    postMoveMenu: { tapTile: "postMoveMenu", cancel: "selected", menuAttack: "targetSelect", menuStrategy: "postMoveMenu", selectStrategy: "postMoveMenu", menuItem: "postMoveMenu", selectItem: "postMoveMenu", menuWait: "animating", menuCancel: "selected", endTurnPressed: "postMoveMenu", endTurnConfirm: "postMoveMenu", autoStart: "postMoveMenu", drained: "postMoveMenu" },
    targetSelect: { tapTile: "targetSelect", cancel: "postMoveMenu", menuAttack: "targetSelect", menuStrategy: "targetSelect", selectStrategy: "targetSelect", menuItem: "targetSelect", selectItem: "targetSelect", menuWait: "targetSelect", menuCancel: "postMoveMenu", endTurnPressed: "targetSelect", endTurnConfirm: "targetSelect", autoStart: "targetSelect", drained: "targetSelect" },
    strategyMenu: { tapTile: "strategyMenu", cancel: "postMoveMenu", menuAttack: "strategyMenu", menuStrategy: "strategyMenu", selectStrategy: "strategyMenu", menuItem: "strategyMenu", selectItem: "strategyMenu", menuWait: "strategyMenu", menuCancel: "postMoveMenu", endTurnPressed: "strategyMenu", endTurnConfirm: "strategyMenu", autoStart: "strategyMenu", drained: "strategyMenu" },
    strategyTarget: { tapTile: "animating", cancel: "strategyMenu", menuAttack: "strategyTarget", menuStrategy: "strategyTarget", selectStrategy: "strategyTarget", menuItem: "strategyTarget", selectItem: "strategyTarget", menuWait: "strategyTarget", menuCancel: "strategyMenu", endTurnPressed: "strategyTarget", endTurnConfirm: "strategyTarget", autoStart: "strategyTarget", drained: "strategyTarget" },
    itemMenu: { tapTile: "itemMenu", cancel: "postMoveMenu", menuAttack: "itemMenu", menuStrategy: "itemMenu", selectStrategy: "itemMenu", menuItem: "itemMenu", selectItem: "itemTarget", menuWait: "itemMenu", menuCancel: "postMoveMenu", endTurnPressed: "itemMenu", endTurnConfirm: "itemMenu", autoStart: "itemMenu", drained: "itemMenu" },
    itemTarget: { tapTile: "animating", cancel: "itemMenu", menuAttack: "itemTarget", menuStrategy: "itemTarget", selectStrategy: "itemTarget", menuItem: "itemTarget", selectItem: "itemTarget", menuWait: "itemTarget", menuCancel: "itemMenu", endTurnPressed: "itemTarget", endTurnConfirm: "itemTarget", autoStart: "itemTarget", drained: "itemTarget" },
    animating: { tapTile: "animating", cancel: "animating", menuAttack: "animating", menuStrategy: "animating", selectStrategy: "animating", menuItem: "animating", selectItem: "animating", menuWait: "animating", menuCancel: "animating", endTurnPressed: "animating", endTurnConfirm: "animating", autoStart: "animating", drained: "idle" },
    enemyTurn: { tapTile: "enemyTurn", cancel: "enemyTurn", menuAttack: "enemyTurn", menuStrategy: "enemyTurn", selectStrategy: "enemyTurn", menuItem: "enemyTurn", selectItem: "enemyTurn", menuWait: "enemyTurn", menuCancel: "enemyTurn", endTurnPressed: "enemyTurn", endTurnConfirm: "enemyTurn", autoStart: "enemyTurn", drained: "idle" },
    autoTurn: { tapTile: "autoTurn", cancel: "autoTurn", menuAttack: "autoTurn", menuStrategy: "autoTurn", selectStrategy: "autoTurn", menuItem: "autoTurn", selectItem: "autoTurn", menuWait: "autoTurn", menuCancel: "autoTurn", endTurnPressed: "autoTurn", endTurnConfirm: "autoTurn", autoStart: "autoTurn", drained: "idle" },
    confirmEndTurn: { tapTile: "confirmEndTurn", cancel: "idle", menuAttack: "confirmEndTurn", menuStrategy: "confirmEndTurn", selectStrategy: "confirmEndTurn", menuItem: "confirmEndTurn", selectItem: "confirmEndTurn", menuWait: "confirmEndTurn", menuCancel: "idle", endTurnPressed: "confirmEndTurn", endTurnConfirm: "animating", autoStart: "confirmEndTurn", drained: "confirmEndTurn" },
    battleOver: { tapTile: "battleOver", cancel: "battleOver", menuAttack: "battleOver", menuStrategy: "battleOver", selectStrategy: "battleOver", menuItem: "battleOver", selectItem: "battleOver", menuWait: "battleOver", menuCancel: "battleOver", endTurnPressed: "battleOver", endTurnConfirm: "battleOver", autoStart: "battleOver", drained: "battleOver" },
  };
